...
// Create a simple decorator for user address extraction
...
export class AddressBookController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all address book entries for the authenticated user with optional pagination',
  })
  @ApiResponse({
    status: 200,
  ...
  async getAllCategories(@UserAddress() userAddress: string) {
    ...
    return this.addressBookService.getAllCategories(userAddress);
  }
  ...
  async searchEntries(
    ...
    return this.addressBookService.searchEntries(
      userAddress,
      searchTerm,
      categoryId,
    );
  ...
  async getEntriesByCategory(
    ...
    return this.addressBookService.getEntriesByCategory(
      userAddress,
      categoryId,
    );
  }
  ...
  async getStatistics(@UserAddress() userAddress: string) {
    ...
    return this.addressBookService.getStatistics(userAddress);
  }
  ...
  async getEntryById(
    ...
    return this.addressBookService.getEntryById(id, userAddress);
  }
  ...
  @ApiOperation({
    ...
    description:
      'Create a new address book entry with validation and duplicate checking',
  })
  @ApiResponse({
    status: 201,
  ...
  async createEntry(
    @UserAddress() userAddress: string,
    @Body() createDto: AddressBookDto,
  ) {
    this.logger.log(`Creating entry for user: ${userAddress}`);
  ...
  @ApiOperation({
    ...
    description: 'Create a new category for organizing address book entries',
  })
  @ApiResponse({
    status: 201,
  ...
  async createCategory(
    ...
    this.logger.log(`Creating category for user: ${userAddress}`);
    return this.addressBookService.createNewCategory(createDto, userAddress);
  }
  ...
  async bulkImport(
    ...
    return this.addressBookService.bulkImportEntries(entries, userAddress);
  }
  ...
  async duplicateEntry(
    ...
    return this.addressBookService.duplicateEntry(id, userAddress);
  }
  ...
  async updateEntry(
    ...
    return this.addressBookService.updateAddressBookEntry(
      id,
      updateDto,
      userAddress,
    );
  ...
  async updateEntriesOrder(
    ...
    await this.addressBookService.updateEntriesOrder(orderUpdates, userAddress);
  ...
  async deleteEntry(
    ...
    await this.addressBookService.deleteAddressBookEntry(id, userAddress);
  ...
  async bulkDelete(
    ...
    await this.addressBookService.bulkDeleteEntries(ids, userAddress);
  ...
  async checkNameDuplicate(
    ...
    const isDuplicate =
      await this.addressBookService.isAddressBookNameDuplicate(
        userAddress,
        name,
        category,
      );
  ...
  async checkAddressDuplicate(
    ...
    const isDuplicate =
      await this.addressBookService.isAddressBookAddressDuplicate(
        userAddress,
        address,
        category,
      );
  ...
  async checkCategoryExists(
    ...
    const exists = await this.addressBookService.checkIfCategoryExists(
      userAddress,
      category,
    );
    return { exists };
