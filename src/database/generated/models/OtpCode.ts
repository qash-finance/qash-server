...
export type OtpCodeWhereInput = {
  ...
  uuid?: Prisma.StringFilter<'OtpCode'> | string;
...
export interface OtpCodeFieldRefs {
  ...
  readonly uuid: Prisma.FieldRef<'OtpCode', 'String'>;
